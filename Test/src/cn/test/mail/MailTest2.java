...
public class MailTest2 {
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        DataHandler dh = new DataHandler(new FileDataSource("C:\\Users\\Administrator\\Desktop\\tId658aaa63dcc0250.80208693.jpeg")); // 读取本地文件
        ...
        DataHandler dh2 = new DataHandler(new FileDataSource("C:\\Users\\Administrator\\Desktop\\test.docx"));  // 读取本地文件
